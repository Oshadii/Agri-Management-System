...
<body >
	<!-- banner -->
	<div class="banner1" id="home" style="background-image: url('ff.jpg');">
						...
						<div id="m_nav_container" class="m_nav wthree_bg">
							<nav class="menu menu--sebastian">
								<ul id="m_nav_list" class="m_nav menu__list">
									<li class="m_nav_item" id="m_nav_item_1"> <a href="farmer.php?fid=<?php echo $fid;?>" class="link link--kumya"><i class="fa fa-user" aria-hidden="true"></i><span data-letters="Profile">Profile</span></a></li>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="signin-form profile">
						...
						<div class="login-form">
						<form action="farmersend.php" method="post">
						...
						<div class="login-form">
							...
							<input name="fid" id="1fid" class="w3-input w3-border" type="hidden" value="<?php echo $fid; ?>">
							 <input name="id" id="id" class="w3-input w3-border" type="hidden">
								...
								<input type="submit" value="Reply" name="replyf">
							</form>
						</div>
					</div>
				</div>
	...
	<div class="banner-bottom">
		...
		<div class="container">
			<h2 class="title-w3-agileits inner">Farmer Message</h2>
...
<div class="tableFixHead">
<button class="btn btn-success" style="float:right;margin-bottom:10px;margin-right:10px" onclick="document.getElementById('add').style.display='block'" data-toggle="modal" data-target="#myModal4">Send a message</button>
<table class="table table-hover table-dark" style="font-size: 15px;margin-left:10px;margin-right:10px;width:97%">
		<thead>
			<tr>
				<th>Farmer ID</th>
