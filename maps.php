...
<div style="width: 100%; height:100px;float:left;background-color:rgba(255,255,255,0.0);">
<h3 style="color:white;margin:2.5% 5%;"><span style="font-size:50px;background-color:green;">K</span>eells & <span  style="font-size:40px;background-color:green;">D</span>OA</h3>

<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 41.3%;font-family:Arial Rounded MT;text-decoration: none;" href="home.php"><i class="fa fa-home" aria-hidden="true"></i><span data-letters="Home"> Home</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 33.5%;font-family:Arial Rounded MT;text-decoration: none;" href="maps.php"><i class="fa fa-map" aria-hidden="true"></i><span data-letters="Map"> Map</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 23.5%;font-family:Arial Rounded MT;text-decoration: none;" href="graphs.php"><i class="fa fa-picture-o" aria-hidden="true"></i><span data-letters="Graphs"> Graphs</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 15%;font-family:Arial Rounded MT;text-decoration: none;" href="login.php"><i class="fa fa-sign-in" aria-hidden="true"></i><span data-letters="Login"> Login</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 4.5%;font-family:Arial Rounded MT;text-decoration: none;" href="contact.html"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="Login"> Contact</span></a>
<hr style="color:white;margin:-2%;">


</div>  
  
    
    <div id="map-canvas" style="width: 75%; height:700px;float:right;"><div id="popup" style="width:400px;height:auto;background-color:rgba(0,0,0,0.6);font-family:Arial Rounded MT;"></div></div>
	<div id="change" style="display:none;float:left;height:700px; width:25%; background-color:rgba(255,255,255,0.5); border-radius:0.5%;">
	<img id="photo" class="img" src="" style=" height:auto;max-height:200px; width:100%;">
	<h2 style="color:#404040;" align="center">Harvest Details</h2>
	<div style="margin-left:25px">
	
	<form method="post" action="evaluate.php">
	<h3 style="color:#404040;" id="name"></h3>
	<h4 style="color:#404040;" id="htype"></h4>
	<h4 style="color:#404040;" id="hname"></h4>
	<h4 style="color:#404040;" id="weight"></h4>
