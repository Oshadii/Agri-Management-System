...
<div style="width: 100%; height:100px;float:left;background-color:rgba(0,0,0,0.0);">
<h3 style="color:white;margin:2.5% 5%;"><span style="font-size:50px;background-color:green;">L</span>ocations <span  style="font-size:40px;background-color:green;">o</span>f <span  style="font-size:40px;background-color:green;">F</span>armers</h3>

<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 33.2%;font-family:Arial Rounded MT;text-decoration: none;" href="staff.php?eid=<?php echo $eid?>"><i class="fa fa-user" aria-hidden="true"></i><span data-letters="Profile"> Profile</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 25.5%;font-family:Arial Rounded MT;text-decoration: none;" href=""><i class="fa fa-map" aria-hidden="true"></i><span data-letters="Map"> Map</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 14.5%;font-family:Arial Rounded MT;text-decoration: none;" href="message.php?eid=<?php echo $eid?>"><i class="fa fa-comment" aria-hidden="true"></i><span data-letters="Message"> Message</span></a>
<a class="btn btn-success" style="font-size:20px;float:right;color:white;margin:-5.5% 5%;font-family:Arial Rounded MT;text-decoration: none;" href="login.php"><i class="fa fa-sign-out" aria-hidden="true"></i><span data-letters="Logout"> Logout</span></a>
